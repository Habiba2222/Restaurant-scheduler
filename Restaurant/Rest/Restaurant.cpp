...
Restaurant::Restaurant() 
{
	...
	NumberOfOrders = 0, ServedOrders = 0;
}
...
void Restaurant::Output()
{
	...
	if (OutputFile.is_open())
	{
		...
		OutputFile << "        " << "MotorC:" << (NormalA + FrozenA + VIPA) << " " << "[Norm:" << NormalA << ", Froz:" << FrozenA << ", VIP:" << VIPA <<"]"<< endl;
		OutputFile << "        " << "Avg Wait=" << " " << ", Avg Serv" << endl;
		OutputFile << "FT" << "   " << "ID" << "   " << "AT" << "   " << "WT" << "   " << "ST" << endl;
		...
		OutputFile << "        " << "MotorC:" << (NormalB + FrozenB + VIPB) << " " << "[Norm:" << NormalB << ", Froz:" << FrozenB << ", VIP:" << VIPB <<"]"<< endl;
		OutputFile << "        " << "Avg Wait=" << " " << ", Avg Serv" << endl;
		OutputFile << "FT" << "   " << "ID" << "   " << "AT" << "   " << "WT" << "   " << "ST" << endl;
		...
		OutputFile << "        " << "MotorC:" << (NormalC + FrozenC + VIPC) << " " << "[Norm:" << NormalC << ", Froz:" << FrozenC << ", VIP:" << VIPC <<" ]"<< endl;
		OutputFile << "        " << "Avg Wait=" << " " << ", Avg Serv" << endl;
		OutputFile << "FT" << "   " << "ID" << "   " << "AT" << "   " << "WT" << "   " << "ST" << endl;
		...
		OutputFile << "        " << "MotorC:" << (NormalD + FrozenD + VIPD) << " " << "[Norm:" << NormalD << ", Froz:" << FrozenD << ", VIP:" << VIPD <<"]"<< endl;
		OutputFile << "        " << "Avg Wait=" << " " << ", Avg Serv" << endl;
	}
}
...
//void Restaurant::Autopromotion()
//{
//	Node<Order*>*A=A_Normal.getHead();
//	Node<Order*>*B=B_Normal.getHead();
//    Node<Order*>*C=C_Normal.getHead();
//	Node<Order*>*D=D_Normal.getHead();
//	if(A!=NULL)
//	{ 
//		int AF = (A->getItem()->getArrTime());
//		while(A && (CurrentTimeStep-AF)>=AutoPromotion)
//		{
//			A_Normal.sethead(A->getNext());
//			A->setNext(NULL);
//			(A->getItem())->setordertype(TYPE_VIP);
//			if (A_VIP.isEmpty())
//			{
//				A_VIP.InsertBeg(A->getItem());
//				ActiveAV++;
//			}
//			else
//			{
...
//					if (pOrd->GetPriority() < A->getItem()->GetPriority())
//					{
//						A_VIP.Insert(i, A->getItem());
//						ActiveAV++;
//						inserted = 1;
//					}
//				}
//				if (inserted == 0)
//				{
//					A_VIP.Insert(A_VIP.getCount() - 1, A->getItem());
//					ActiveAV++;
//				}
//			}
//			A=A_Normal.getHead();
...
//		while(A->getNext())
//		{ 
//			Node<Order*>*ptr=A->getNext();
//			int AFP = (ptr->getItem()->getArrTime());
//			if((CurrentTimeStep-AFP)>=AutoPromotion)
//			{
//				A->setNext(ptr->getNext());
//				A_Normal.decrementcount();
//				ptr->setNext(NULL);
//				(ptr->getItem())->setordertype(TYPE_VIP);
//				if (A_VIP.isEmpty())
//				{
//					A_VIP.InsertBeg(A->getItem());
//					ActiveAV++;
...
//	if(B!=NULL)
//	{ 
//		while(B && (B->getItem())->getwaittime()>=AutoPromotion)
//		{ 
//			B_Normal.sethead(B->getNext());
//			B->setNext(NULL);
//			(B->getItem())->setordertype(TYPE_VIP);
//			if (B_VIP.isEmpty())
//			{
//				B_VIP.InsertBeg(B->getItem());
//				ActiveBV++;
//			}
//			else
//			{
...
//						if (pOrd->GetPriority() < B->getItem()->GetPriority())
//							{
//								B_VIP.Insert(i, B->getItem());
//								ActiveDV++;
//								inserted = 1;
//							}
//					}
//				if (inserted == 0)
//				   {
//						B_VIP.Insert(B_VIP.getCount() - 1, B->getItem());
//						ActiveDV++;
//					}
//			}	
//			B=B_Normal.getHead();
...
//		while(B->getNext())
//		{ 
//			Node<Order*>*ptr=B->getNext();
//			if((ptr->getItem())->getwaittime()>=AutoPromotion)
//			{
//				B->setNext(ptr->getNext());
//				B_Normal.decrementcount();
//				ptr->setNext(NULL);
//				(ptr->getItem())->setordertype(TYPE_VIP);
//				if (B_VIP.isEmpty())
//				{
...
//	if(C!=NULL)
//	{ 
//		while(C && (C->getItem())->getwaittime()>=AutoPromotion)
//		{ 
//			C_Normal.sethead(C->getNext());
//			C->setNext(NULL);
//			(C->getItem())->setordertype(TYPE_VIP);
//			 if (C_VIP.isEmpty())
//			 {
//				 C_VIP.InsertBeg(C->getItem());
//				 ActiveDV++;
//			 }
//			 else
//			 {
...
//					if (pOrd->GetPriority() < C->getItem()->GetPriority())
//						{
//							C_VIP.Insert(i, C->getItem());
//							ActiveDV++;
//							inserted = 1;
//						}
//				 }
//				 if (inserted == 0)
//				 {
//					C_VIP.Insert(C_VIP.getCount() - 1, C->getItem());
//					ActiveDV++;
//				}
//			 }
//			 C=C_Normal.getHead();
...
//		while(C->getNext())
//		{ 
//			Node<Order*>*ptr=C->getNext();
//			if((ptr->getItem())->getwaittime()>=AutoPromotion)
//			{
//				C->setNext(ptr->getNext());
//				C_Normal.decrementcount();
//				ptr->setNext(NULL);
//				(ptr->getItem())->setordertype(TYPE_VIP);
//				 if (C_VIP.isEmpty())
//				 {
...
//	if(D!=NULL)
//	{ 
//		while(D && (D->getItem())->getwaittime()>=AutoPromotion)
//		{
//			D_Normal.sethead(D->getNext());
//			D->setNext(NULL);
//			(D->getItem())->setordertype(TYPE_VIP);
//			 if (D_VIP.isEmpty())
//			 {
//				 D_VIP.InsertBeg(D->getItem());
//				 ActiveDV++;
//			 }
//			 else
//			 {
...
//				 {
//					 pOrd = D_VIP.getOrder(i);
//					 if (pOrd->GetPriority() < D->getItem()->GetPriority())
//						{
//							D_VIP.Insert(i, D->getItem());
//							ActiveDV++;
//							inserted = 1;
//						}
//				 }
//				 if (inserted == 0)
//				 {
//					D_VIP.Insert(D_VIP.getCount() - 1, D->getItem());
//					ActiveDV++;
//				 }
//			 }
//			 D=D_Normal.getHead();
...
//		while(D->getNext())
//		{
//			Node<Order*>*ptr=D->getNext();
//			if((ptr->getItem())->getwaittime()>=AutoPromotion)
//			{
//				D->setNext(ptr->getNext());
//				D_Normal.decrementcount();
//				ptr->setNext(NULL);
//				(ptr->getItem())->setordertype(TYPE_VIP);
//				 if (D_VIP.isEmpty())
//				 {
